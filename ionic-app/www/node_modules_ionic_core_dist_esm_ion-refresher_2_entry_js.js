...
/* harmony import */ var _animation_437b04e8_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./animation-437b04e8.js */ 91);
/* harmony import */ var _index_e3f61316_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./index-e3f61316.js */ 341);
/* harmony import */ var _index_dff497fb_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./index-dff497fb.js */ 1652);
/* harmony import */ var _spinner_configs_5d6b6fe7_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./spinner-configs-5d6b6fe7.js */ 3844);
...
const createBaseAnimation = pullingRefresherIcon => {
  ...
  const baseAnimation = (0,_animation_437b04e8_js__WEBPACK_IMPORTED_MODULE_6__.c)().duration(1000).easing('ease-out');
  const spinnerArrowContainerAnimation = (0,_animation_437b04e8_js__WEBPACK_IMPORTED_MODULE_6__.c)().addElement(spinnerArrowContainer).keyframes([{
    offset: 0,
    opacity: '0.3'
  }, {
    offset: 0.45,
  ...
  const circleInnerAnimation = (0,_animation_437b04e8_js__WEBPACK_IMPORTED_MODULE_6__.c)().addElement(circle).keyframes([{
    offset: 0,
  ...
  const circleOuterAnimation = (0,_animation_437b04e8_js__WEBPACK_IMPORTED_MODULE_6__.c)().addElement(spinner).keyframes([{
    offset: 0,
  ...
  if (arrowContainer && arrow) {
    const arrowContainerAnimation = (0,_animation_437b04e8_js__WEBPACK_IMPORTED_MODULE_6__.c)().addElement(arrowContainer).keyframes([{
      offset: 0,
    ...
    const arrowAnimation = (0,_animation_437b04e8_js__WEBPACK_IMPORTED_MODULE_6__.c)().addElement(arrow).keyframes([{
      offset: 0,
...
const createScaleAnimation = (pullingRefresherIcon, refresherEl) => {
  ...
  const spinnerAnimation = (0,_animation_437b04e8_js__WEBPACK_IMPORTED_MODULE_6__.c)().addElement(pullingRefresherIcon).keyframes([{
    offset: 0,
...
const createSnapBackAnimation = pullingRefresherIcon => {
  return (0,_animation_437b04e8_js__WEBPACK_IMPORTED_MODULE_6__.c)().duration(125).addElement(pullingRefresherIcon).fromTo('transform', 'translateY(var(--ion-pulling-refresher-translate, 100px))', 'translateY(0px)');
...
const handleScrollWhilePulling = (ticks, numTicks, pullAmount) => {
  ...
  (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_1__.c)(() => {
    ticks.forEach((el, i) => {
      ...
      const progression = (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_4__.k)(0, start / range, 1);
...
const translateElement = (el, value, duration = 200) => {
  ...
  const trans = (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_4__.t)(el, duration);
  (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_1__.c)(() => {
...
const shouldUseNativeRefresher = /*#__PURE__*/function () {
  var _ref = (0,_Users_mraible_Downloads_okta_jhipster_ionic_example_ionic_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (referenceEl, mode) {
    ...
    yield new Promise(resolve => (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_4__.c)(refresherContent, resolve));
...
const Refresher = class {
  ...
  resetNativeRefresher(el, state) {
    ...
    return (0,_Users_mraible_Downloads_okta_jhipster_ionic_example_ionic_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      if ((0,_ionic_global_f1ce4d2d_js__WEBPACK_IMPORTED_MODULE_2__.b)(_this2) === 'ios') {
        ...
        yield (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_4__.t)(_this2.el.querySelector('.refresher-refreshing-icon'), 200);
      }
        ...
        (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_1__.f)(() => {
          ...
          if (scrollTop > 0) {
            ...
            /* Refreshing */
              ...
              const ratio = (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_4__.k)(0, scrollTop / (refresherHeight * 0.5), 1);
          ...
          const pullAmount = _this3.progress = (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_4__.k)(0, (Math.abs(scrollTop) - offset) / MAX_PULL, 1);
          ...
          if (shouldShowRefreshingSpinner) {
            ...
            if (!_this3.didRefresh) {
              ...
              (0,_haptic_683b3b3c_js__WEBPACK_IMPORTED_MODULE_5__.d)({
                style: 'light'
              });
              /**
  ...
  setupMDNativeRefresher(contentEl, pullingSpinner, refreshingSpinner) {
    ...
    return (0,_Users_mraible_Downloads_okta_jhipster_ionic_example_ionic_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const circle = (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_4__.g)(pullingSpinner).querySelector('circle');

      const pullingRefresherIcon = _this4.el.querySelector('ion-refresher-content .refresher-pulling-icon');

      const refreshingCircle = (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_4__.g)(refreshingSpinner).querySelector('circle');
      ...
      _this4.gesture = (yield Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./index-3f1a7d95.js */ 2172))).createGesture({
        ...
        onMove: ev => {
          ...
          _this4.progress = (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_4__.k)(0, ev.deltaY / 180 * 0.5, 1);
        ...
        onEnd: ev => {
          ...
          (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_1__.c)( /*#__PURE__*/(0,_Users_mraible_Downloads_okta_jhipster_ionic_example_ionic_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
  ...
  connectedCallback() {
    ...
    return (0,_Users_mraible_Downloads_okta_jhipster_ionic_example_ionic_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this6.backgroundContentEl = (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_4__.g)(contentEl).querySelector('#background-content');
    ...
    return (0,_Users_mraible_Downloads_okta_jhipster_ionic_example_ionic_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this7.nativeRefresher) {
        ...
        if (!_this7.pointerDown) {
          (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => _this7.resetNativeRefresher(_this7.elementToTransform, 32
          /* Completing */
          )));
        }
      } else {
    ...
    return (0,_Users_mraible_Downloads_okta_jhipster_ionic_example_ionic_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this8.nativeRefresher) {
        ...
        if (!_this8.pointerDown) {
          (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => _this8.resetNativeRefresher(_this8.elementToTransform, 16
          /* Cancelling */
          )));
        }
      } else {
...
const RefresherContent = class {
  ...
  render() {
    ...
    const hasSpinner = pullingIcon != null && _spinner_configs_5d6b6fe7_js__WEBPACK_IMPORTED_MODULE_9__.S[pullingIcon] !== undefined;
    const mode = (0,_ionic_global_f1ce4d2d_js__WEBPACK_IMPORTED_MODULE_2__.b)(this);
    return (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_1__.H, {
      class: mode
      ...
      innerHTML: (0,_index_dff497fb_js__WEBPACK_IMPORTED_MODULE_8__.s)(this.pullingText)
    })), (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      ...
      innerHTML: (0,_index_dff497fb_js__WEBPACK_IMPORTED_MODULE_8__.s)(this.refreshingText)
    })));
  }

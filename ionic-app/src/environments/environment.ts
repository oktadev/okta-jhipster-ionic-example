...
const oidcConfig: IAuthConfig = {
  client_id: 'Tz7nrQ36DkcKmtuDMTZfi76tVMn7LDge', // auth0: Tz7nrQ36DkcKmtuDMTZfi76tVMn7LDge, okta: 0oa4y67wyllNCJrDZ5d7
...
export const environment = {
  ...
  apiUrl: `${apiHost}api`,
  oidcConfig,
  audience: 'https://dev-06bzs1cu.us.auth0.com/api/v2/', // auth0: https://dev-06bzs1cu.us.auth0.com/api/v2/
